...
Projeto desenvolvido em **Python** durante meus estudos de **Sistemas de Informação**, com o objetivo de aplicar na prática conceitos de **Tipos Abstratos de Dados (TADs)**, **Programação Orientada a Objetos (POO)**, encapsulamento, modularização e organização de código.
